from botexe.Data.replyraid import REPLYRAID
import random
from config import HANDLER as hl
import asyncio
from botexe.Database.replyraid import *
from pyrogram import Client, filters 
from botexe import Ubot

@Ubot.on_message(filters.command("replyraid", hl) & filters.me)
...
@Ubot.on_message(filters.command("dreplyraid", hl) & filters.me)
