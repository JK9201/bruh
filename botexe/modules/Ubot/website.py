...
@Ubot.on_message(filters.command("webss", hl) & filters.me)
async def webshot(client, message):
    try:
        ...
        try:
            ...
            await client.send_photo(message.chat.id, full_link, caption=f"** ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴏꜰ ᴛʜᴇ ᴘᴀɢᴇ** `{user_link}`")
        ...
        await client.send_message(
            message.chat.id, f"**» ᴛʜɪs ɪs ɴᴏᴛ ᴀ ᴠᴀʟɪᴅ ᴜʀʟ...**"
        )
